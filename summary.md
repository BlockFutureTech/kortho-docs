...
KroTho通过共识机制的优化，带来高效低延迟、低手续费的特性，同时具有以太坊友好的智能合约兼容性。

KroTho包括基础组件层、共识算法层、智能合约层等技术架构。
...
KroTho采用KBFT共识机制，该机制提供了一种解决去中心化系统中各节点如何达成一致的方案，具有交易成本低、交易延时低、交易并发高等特点。节点的激励为链上交易的手续费。
```
...
## 元交易功能
支持元交易功能，可以实现用户阶梯式减免Gas费，由KroTho代替用户支付；元交易方案可有效降低DApp开发者的迁移成本，也可大幅降低用户使用Dapp的成本。
